...
use Illuminate\Support\Facades\Session;
 ...
 if($message = Session::get('success')): ?>
                    ...
                    <!-- Form -->
                    <form action="<?php echo e(route('create_artist')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="p-t-15 text-center">
                            ...
                            <p>Already have an account? <a href="<?php echo e(route('makeup_artist_login')); ?>">Sign in</a></p>
...
<!-- end document--><?php /**PATH E:\Samanta\Laravel\Makeup_Artist\resources\views/frontend/layouts/registration/makeup_artist_registration.blade.php ENDPATH**/ ?>