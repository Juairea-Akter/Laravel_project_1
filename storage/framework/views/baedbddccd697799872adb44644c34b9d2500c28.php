        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('create_customer')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="p-t-15 text-center">
                            ...
                            <p>Already have an account? <a href="<?php echo e(route('customer_login')); ?>">Sign in</a></p>
...
<!-- end document--><?php /**PATH E:\Samanta\Laravel\Makeup_Artist\resources\views/frontend/layouts/registration/cus_registration.blade.php ENDPATH**/ ?>