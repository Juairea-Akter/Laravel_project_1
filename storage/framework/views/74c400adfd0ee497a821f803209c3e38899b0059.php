			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				...
				<form class="login100-form validate-form" action="<?php echo e(route('makeup_login')); ?>" method="post">
					...
					<div class="text-center w-full p-t-115">
						...
						<a class="txt1 bo1 hov1" href="<?php echo e(route('cus_registration')); ?>">
							Sign up now
						</a>
					</div>
				</form>
...
</html><?php /**PATH E:\Samanta\Laravel\Makeup_Artist\resources\views/frontend/layouts/login/customer_login.blade.php ENDPATH**/ ?>