...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <td>
        <a class="btn btn" href="<?php echo e(route('makeup_artist_service_edit',$sub_category->id)); ?>" role="button"><i class="fa-solid fa-pen-to-square"></i></a>
        <a class="btn btn" href="<?php echo e(route('makeup_artist_service_delete',$sub_category->id)); ?>" role="button"><i class="fa-solid fa-trash"></i></a>
      </td>
            </td>
