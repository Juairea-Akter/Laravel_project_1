    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <?php else: ?>
          <a href="<?php echo e('/uploads/profile/'.$user->image); ?>">
            <img src="<?php echo e(asset('/uploads/profile/'.$user->image)); ?>" height="50px" width="50px">
          </a>
          <?php endif; ?>
        </td>
        <td>
          <?php if($user->doc == null): ?>
          <img src="<?php echo e(asset('/uploads/profile/dummy.jpg')); ?>" height="50px" width="50px">
          <?php else: ?>
          <a href="<?php echo e('/uploads/profile/'.$user->doc); ?>">
            <img src="<?php echo e(asset('/uploads/profile/'.$user->doc)); ?>" height="50px" width="50px">
          </a>
          <?php endif; ?>
        </td>
        <td>
